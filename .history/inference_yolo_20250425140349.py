...
class FruitDetectionGUI(QMainWindow):
    ...
    def update_frame(self):
        ...
        self.frame_count += 1
        # Resize frame dengan mempertahankan rasio aspek
        original_h, original_w = frame.shape[:2]
        target_size = 640  # Ukuran target untuk dimensi terpanjang
        ...
        # Gunakan torch.no_grad untuk inferensi
        with torch.no_grad():
        ...
        # Update GUI hanya setiap 2 frame

...
class SimpleFruitDetectionGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.video_label.setStyleSheet("background-color: #ffffff; border: 1px solid #dcdcdc;")
        ...
        self.thumbnail_label.setStyleSheet("background-color: #ffffff; border: 1px solid #dcdcdc;")
    ...
    def update_thumbnail(self):
        ...
        try:
            ...
            if not cap.isOpened():
                self.thumbnail_label.setText("Invalid Video")

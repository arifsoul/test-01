...
def init_kalman_filter():
    """Initialize Kalman Filter for tracking position and velocity with optimized parameters."""
    ...
    kf.R = np.eye(2) * 5.0  # Reduced measurement noise for smoother updates
    kf.P = np.eye(4) * 100  # Lower initial uncertainty
    kf.Q = np.eye(4) * 0.01  # Reduced process noise for stable predictions
    return kf

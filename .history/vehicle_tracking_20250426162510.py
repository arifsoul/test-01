...
# Generate HTML report with Recharts (fixed raw blocks for Jinja)
                    ...
                    <div className="chart-container">
                        ...
                        <Recharts.ResponsiveContainer width="100%" height={300}>
                            <Recharts.BarChart data={locationChartData}>
                                <Recharts.CartesianGrid strokeDasharray="3 3" />
                                <Recharts.XAxis dataKey="location" label={% raw %}{ value: 'Location', position: 'insideBottom', offset: -5 }{% endraw %} tick={% raw %}{ fontSize: 12 }{% endraw %} />
                                <Recharts.YAxis label={% raw %}{ value: 'Count', angle: -90, position: 'insideLeft' }{% endraw %} />
                                <Recharts.Tooltip />
                                <Recharts.Legend />
                    ...
                    <div className="chart-container">
                        ...
                        <Recharts.ResponsiveContainer width="100%" height={300}>
                            <Recharts.BarChart data={clusterChartData}>
                                <Recharts.CartesianGrid strokeDasharray="3 3" />
                                <Recharts.XAxis dataKey="cluster" label={% raw %}{ value: 'Cluster ID', position: 'insideBottom', offset: -5 }{% endraw %} />
                                <Recharts.YAxis label={% raw %}{ value: 'Count', angle: -90, position: 'insideLeft' }{% endraw %} />
                                <Recharts.Tooltip />
                                <Recharts.Legend />

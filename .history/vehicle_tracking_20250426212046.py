...
def generate_html_report(data, le_type, le_location):
    ...
    <body class="bg-gray-100 p-6">
        ...
        <script>
            // Data for charts
            const typeChartData = {json.loads(type_chart_json)};
            const locationChartData = {json.loads(location_chart_json)};
            const clusterChartData = {json.loads(cluster_chart_json)};

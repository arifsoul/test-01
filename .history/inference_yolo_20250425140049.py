...
class FruitDetectionGUI(QMainWindow):
    ...
    def update_frame(self):
        ...
        target_size = 416  # Smaller input size for faster inference
        ...
        # Inference
        with torch.no_grad():
            results = self.model.track(frame, persist=True, verbose=False, device=self.device, half=(self.device == 'cuda'))

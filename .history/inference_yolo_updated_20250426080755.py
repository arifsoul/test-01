...
tracked_objects = {}  # Store tracked objects: {track_id: {'center': (x, y), 'class': cls, 'confidence': conf, 'box': (x1, y1, x2, y2), 'kalman': KalmanFilter, 'last_seen': frame_count}}
...
class SimpleFruitDetectionGUI(QMainWindow):
    ...
    def update_frame(self):
        ...
        line_y = int(height * self.line_y_ratio)  # Pastikan line_y adalah integer
                        ...
                        for existing_id, obj in tracked_objects.items():
                            ...
                            if distance < self.tracking_threshold:
                                ...
                                if cls != obj['class'] and conf > obj['confidence']:
                                    ...
                                    # Keep existing object, update Kalman Filter with new measurement
        ...
        for track_id, obj in list(tracked_objects.items()):
            ...
            width_box = x2 - x1
            height_box = y2 - y1
            new_x1 = new_center_x - width_box / 2
            new_x2 = new_center_x + width_box / 2
            new_y1 = new_center_y - height_box / 2
            new_y2 = new_center_y + height_box / 2
        ...
        # Draw counting line, ensure frame is valid
